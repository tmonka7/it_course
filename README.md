...
| My Profile | Every user edits their own name, phone, job title, department, about text and photo, changes their password, and registers their face (3–5 webcam samples) for recognition. Opened from the user menu in the header. |
